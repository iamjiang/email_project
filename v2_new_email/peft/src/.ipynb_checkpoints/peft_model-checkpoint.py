...
from adalora import AdaLoraModel
from adaption_prompt import  AdaptionPromptModel
from lora import  LoraModel
from prefix_tuning import PrefixEncoder
from prompt_tuning import PromptEmbedding
from  p_tuning import PromptEncoder

from other import TRANSFORMERS_MODELS_TO_PREFIX_TUNING_POSTPROCESS_MAPPING,WEIGHTS_NAME, _set_adapter, _set_trainable,shift_tokens_right

from config import PeftConfig, PeftType,PromptLearningConfig,TaskType

from prefix_tuning import PrefixTuningConfig
from prompt_tuning import PromptTuningConfig
from  p_tuning import PromptEncoderConfig
...
class PeftModel(torch.nn.Module):
    ...
    **Attributes**:
    ...
    @classmethod
    def from_pretrained(cls,save_directory, model, model_id, adapter_name="default", is_trainable=False, **kwargs):
        r"""
        ...
        config = PEFT_TYPE_TO_CONFIG_MAPPING[
            PeftConfig.from_pretrained(save_directory,model_id).peft_type
        ].from_pretrained(save_directory,model_id)
        ...
        model.load_adapter(save_directory,model_id, adapter_name, **kwargs)
        return model
    ...
    def load_adapter(self, save_directory, model_id, adapter_name, is_trainable=False, **kwargs):
        ...
        # load weights if any
        path = os.path.join(save_directory,model_id) 
